      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <header className='text-center mb-20 pt-12'>
          ...
          <div className='flex flex-wrap items-center justify-center gap-4'>
            <button className='px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-colors shadow-lg shadow-blue-500/25'>
              Bắt đầu ngay
            </button>
            <button className='px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-xl transition-colors border border-slate-700'>
              Tìm hiểu thêm
            </button>
          </div>
        </header>
        ...
        <div className='grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-20'>
          ...
          <div className='group relative bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-300'>
          ...
          <div className='group relative bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300'>
